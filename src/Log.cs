...
namespace KSCVessels
{
    internal class Log
    {
        ...
        {
            UnityEngine.Debug.Log("KSCVessels: " + message);
        }
        ...
        {
            UnityEngine.Debug.LogWarning("KSCVessels: " + new StackFrame(1, true).GetMethod().Name + ": " + message);
        }
        ...
        {
            UnityEngine.Debug.LogError("KSCVessels: " + new StackFrame(1, true).GetMethod().Name + ": " + message);
        }
        ...
        {
#if DEBUG
            UnityEngine.Debug.Log("KSCVessels: " + new StackFrame(1, true).GetMethod().Name + ": " + message);
#endif
        }
